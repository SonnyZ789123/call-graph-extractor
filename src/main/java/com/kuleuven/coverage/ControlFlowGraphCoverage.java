...
import com.kuleuven.coverage.ExecutionPathTracker.BlockRegistry;
...
//
//            int offset = entry.getPositionInfo().getStmtPosition().getFirstLine();
//
...
//        }
        ...
        System.out.println(BlockRegistry.getBlocks());
    }
}
